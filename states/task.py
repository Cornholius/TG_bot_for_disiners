...
class Task(StatesGroup):
    need_image_question = "В объявлении будут использоваться изображения? При нажатии кнопки 'Да' бот будет ожидать от Вас группу изображений от 2 до 10 и не отстанет, пока вы ему их не скините"
